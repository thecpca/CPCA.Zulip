...
ZULIP_ADMINISTRATOR = "root@thecpca.ca"
...
EXTERNAL_HOST = "zulip.thecpca.ca"
...
SOCIAL_AUTH_OIDC_ENABLED_IDPS: dict[str, Any] = {
    ...
    "idp_name": {
        ...
        "oidc_url": "https://auth.thecpca.ca",
...
EMAIL_HOST_USER = 'AKIAYS2NTOYCHEHFBJ7Y'
EMAIL_PORT = 587
EMAIL_USE_SSL = False
EMAIL_USE_TLS = True
EXTERNAL_HOST = 'zulip.thecpca.ca'
...
REDIS_HOST = 'redis'
REMOTE_POSTGRES_HOST = 'cpca-postgres'
